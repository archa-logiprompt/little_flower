	    ...
	    if (($this->rbac->hasPrivilege('minutes_detail', 'can_view')
            ...
            <li class="treeview <?php echo set_Topmenu('Attendance'); ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?php echo set_Submenu('stuattendence/classattendencereportbyday'); ?>"><a
...
/*
                    ...
                    <li class="<?php echo set_Submenu('mark/internalmarks'); ?>"><a
                               ...
                               $this->rbac->hasPrivilege('assign_class_teacher', 'can_view') ||
                                $this->rbac->hasPrivilege('class', 'can_view') ||
                                 $this->rbac->hasPrivilege('section', 'can_view')||
                                  $this->rbac->hasPrivilege('period_timing', 'can_view'))) {
                                ?>
            <li class="treeview <?php echo set_Topmenu('Academics'); ?>">
                ...
                <ul class="treeview-menu">
                           ...
                           href="<?php //echo base_url(); ?>admin/worklog"><i class="fa fa-angle-double-right"></i> Work
                            ...
                            <?php
                                          ...
                                          if ($this->rbac->hasPrivilege('period_timing', 'can_view')) {
                                            ?>
                    <li class="<?php echo set_Submenu('weeklycalendarnew/periodtiming'); ?>"><a
                            href="<?php echo base_url(); ?>admin/weeklycalendarnew/periodtiming"><i
                                class="fa fa-angle-double-right"></i> Period Timing </a></li>
                     <?php
                                 }
                    ...
                    if ($this->rbac->hasPrivilege('passed_out', 'can_view')) {
                                ?>
        <li class="<?php echo set_Submenu('subject/passed_out'); ?>"><a
                href="<?php echo base_url(); ?>student/passedout"><i class="fa fa-angle-double-right"></i>
            Passed Out</a></li>
        <?php 
}
  ...
  if ($this->rbac->hasPrivilege('assigned_staff', 'can_view')) {
                    ...
                    <li class="<?php echo set_Submenu('admin/leaverequest/leaverequesthod'); ?>"><a
                            href="<?php echo base_url(); ?>admin/leaverequest/leaverequesthod"><i
                                class="fa fa-angle-double-right"></i>
                            <?php echo "Leave Approval-HOD " ?> </a></li> 
                   <?php
                                        }
 ...
 <?php if ($this->rbac->hasPrivilege('pdf_drive', 'can_view')) { ?>
                    ...
                    <li class="<?php echo set_Submenu('library/pdf_drive'); ?>"><a
                            href="https://www.pdfdrive.com/nursing-books.html"><i
                                class="fa fa-angle-double-right"></i><?php echo 'PDF Drive'; ?></a></li>
 
                        <?php } elseif($centre_id==2){
                            
                        ?>
                    <li class="<?php echo set_Submenu('library/pdf_drive'); ?>"><a
                            href="https://www.pdfdrive.com/medical-books.html"><i
                                class="fa fa-angle-double-right"></i><?php echo 'PDF Drive'; ?></a></li>
                        ...
                        ?>
                    <li class="<?php echo set_Submenu('library/pdf_drive'); ?>"><a
                            href="https://www.pdfdrive.com/search?q=paramedic&pagecount=&pubyear=&searchin=&em="><i
                                class="fa fa-angle-double-right"></i><?php echo 'PDF Drive'; ?></a></li>
