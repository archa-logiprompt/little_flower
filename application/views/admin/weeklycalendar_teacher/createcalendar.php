...
<div class="content-wrapper" style="/* [disabled]min-height: 946px; */">
    ...
    <section class="content-header">
        ...
        <h1>
            <i class="fa fa-mortar-board"></i> <?php echo "Timetable" ?>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select autofocus="" id="period_id" name="class_id"
                                                                ...
                                                                <option value="eight_to_nine_div"><?php echo "$period_list->period_one_from - $period_list->period_one_to" ?>
                                                                </option>
                                                                <option value="nine_to_ten_div"><?php echo "$period_list->period_two_from - $period_list->period_two_to" ?>
                                                                </option>
                                                                <option value="ten_to_eleven_div"><?php echo "$period_list->period_three_from - $period_list->period_three_to" ?>
                                                                </option>
                                                                <option value="eleven_to_twelve_div"><?php echo "$period_list->period_four_from - $period_list->period_four_to" ?>
                                                                </option>
                                                                <option value="twelve_to_one_div"><?php echo  "$period_list->period_five_from - $period_list->period_five_to" ?>
                                                                </option>
                                                                <option value="two_to_three_div"><?php echo "$period_list->period_six_from - $period_list->period_six_to" ?>
                                                                </option>
                                                                <option value="three_to_four_div"><?php echo "$period_list->period_seven_from - $period_list->period_seven_to" ?>
                                                                </option>
                                                                <option value="four_to_five_div"><?php echo "$period_list->period_eight_from - $period_list->period_eight_to" ?>
                                                                </option>
                                            ...
                                            <div class="teacher-div eight_to_nine_div">
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="hidden" id="report_id_eight_to_nine" name="report_id_eight_to_nine">
                                                    <select autofocus="" id="topic_id_eight_to_nine" name="topic_id" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    <button class="btn btn-success attendance-button "> Attendance
                                                        <button class="btn btn-primary save-period pull-right" is-update="true"> Save
                                                </div>
                                            </div>
                                            <div class="teacher-div nine_to_ten_div">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="exampleInputEmail1">Topics</label>
                                                    <input type="hidden" id="report_id_nine_to_ten" name="report_id_nine_to_ten">
                                                    <select autofocus="" id="topic_id_nine_to_ten" name="topic_id" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            ...
                                            <div class="teacher-div ten_to_eleven_div">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="exampleInputEmail1">Topics</label>
                                                    <input type="hidden" id="report_id_ten_to_eleven" name="report_id_ten_to_eleven">
                                                    <select autofocus="" id="topic_id_ten_to_eleven" name="topic_id" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            ...
                                            <div class="teacher-div eleven_to_twelve_div">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="exampleInputEmail1">Topics</label>
                                                    <input type="hidden" id="report_id_eleven_to_twelve" name="report_id_eleven_to_twelve">
                                                    <select autofocus="" id="topic_id_eleven_to_twelve" name="topic_id" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            ...
                                            <div class="teacher-div twelve_to_one_div">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="exampleInputEmail1">Topics</label>
                                                    <input type="hidden" id="report_id_twelve_to_one" name="report_id_twelve_to_one">
                                                    <select autofocus="" id="topic_id_twelve_to_one" name="topic_id" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            ...
                                            <div class="teacher-div two_to_three_div">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="exampleInputEmail1">Topics</label>
                                                    <input type="hidden" id="report_id_two_to_three" name="report_id_two_to_three">
                                                    <select autofocus="" id="topic_id_two_to_three" name="topic_id" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            ...
                                            <div class="teacher-div three_to_four_div">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="exampleInputEmail1">Topics</label>
                                                    <input type="hidden" id="report_id_three_to_four" name="report_id_three_to_four">
                                                    <select autofocus="" id="topic_id_three_to_four" name="topic_id" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            ...
                                            <div class="teacher-div four_to_five_div">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label for="exampleInputEmail1">Topics</label>
                                                    <input type="hidden" id="report_id_four_to_five" name="report_id_four_to_five">
                                                    <select autofocus="" id="topic_id_four_to_five" name="topic_id" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
                            ...
                            success: function(response) {
                                ...
                                $.each(response, function(index, topic) {
                                    topicSelect += '<option value="' + topic.topic_id + '"' +
                                        (data.topic == topic.topic_id ? ' selected="selected"' : '') +
                                        '>' + topic.topic + '</option>';
                                });
                                $('#topic_id_' + period.replace(/_div/g, "")).html(topicSelect);
                                $('#report_id_' + period.replace(/_div/g, "")).val(data.period_id);
                                if (data.status == 1) {
                                    $('#topic_id_' + period.replace(/_div/g, "")).attr('disabled', true);
                                } else {
                                    $('#topic_id_' + period.replace(/_div/g, "")).removeAttr('disabled');
        ...
        $(document).on('click', '.save-period', function(e) {
            ...
            let topic = $parent.find('#topic_id_' + ($('#period_id').val()).replace(/_div/g, "")).val();
            ...
            let tableid = $parent.find('#report_id_' + ($('#period_id').val()).replace(/_div/g, "")).val();
