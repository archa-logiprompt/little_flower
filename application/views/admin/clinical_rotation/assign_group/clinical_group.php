        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo site_url('admin/clinical_group') ?>" method="post" class="">
...
<script type="text/javascript">
    $(document).on('click', '.btn_save', function (e) {
	  ...
	  var section_id=$('#section_id').val();
        ...
        var existinggroup = $('#group').val();
		var studentsessionid = $('#studentsessionid').val();
		var student_sess_id=studentsessionid.split(',');
        
        $.ajax({
            url: '<?php echo site_url("admin/clinical_group/assign_group") ?>',
            type: 'post',
            data: {groupname: groupname, student_sess_id: student_sess_id,class_id: class_id,section_id: section_id,group:existinggroup},
            dataType: 'json',
            success: function (response) {
                ...
                if (response.status == "success") {
					...
					document.location ='<?php echo site_url("admin/clinical_group/view_clinicalgroup") ?>';
