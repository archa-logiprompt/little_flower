    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-calendar-check-o"></i> <?php echo $this->lang->line('attendance'); ?> <small>
                <?php echo $this->lang->line('by_date1'); ?></small>
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/clinical_department/clinical_attendance') ?>"
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label
                                            for="exampleInputEmail1"><?php echo $this->lang->line('group'); ?></label>
                ...
                if (isset($resultlist)) {
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-users"></i> <?php echo $this->lang->line('student'); ?>
                                <?php echo $this->lang->line('list'); ?></h3>
                        ...
                        <div class="box-body">
                            ...
                            if (!empty($resultlist)) {
                                ...
                                if (!isset($msg)) {
                                    if ($resultlist[0]['attendance_type_id'] != 0) {
                                        ...
                                        <div class="alert alert-warning">
                                            <?php echo $this->lang->line('attendance_already_submitted_you_can_edit_record'); ?></div>
                                        <?php
                                        //} else {
                                ...
                                ?>
                                <form action="<?php echo site_url('admin/clinical_department/save_attendance') ?>"
                                    method="post">
                                    <?php echo $this->customlib->getCSRF(); ?>
                                    <div class="mailbox-controls">
                                        <span class="button-checkbox">
                                            <!-- <button type="button" class="btn btn-sm btn-primary"
                                                data-color="primary"><?php echo $this->lang->line('mark_as_holiday'); ?></button> -->
                                        </span>
                                        <div class="pull-right">
                                            <button type="submit" name="search" value="saveattendence"
                                                class="btn btn-primary btn-sm pull-right checkbox-toggle"><i
                                                    class="fa fa-save"></i> <?php echo $this->lang->line('save_attendance'); ?>
                                            </button>
                                            ...
                                            <tbody>
                                                <?php
                                                    if($checkres){
                                                        ?>
                                                        <div class="alert alert-warning">
                                                        Attendance was already submitted. You can now edit this.</div>
                                                ...
                                                foreach ($resultlist as $key => $value) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <input type="hidden" value="<?php echo $value['attendance_id']; ?>"
                                                                name="attendendence_id<?php echo $value['student_session_id']; ?>">
                                                            <?php echo $row_count; ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            foreach ($attendencetypeslist as $index => $type) {
                                                                ...
                                                                if ($type['key_value'] != "H") {
                                                                    ...
                                                                    if ($checkres != null) {
                                                                        ...
                                                                        <div class="radio radio-info radio-inline">
                                                                            <input <?php if ($checkres[$key]['attendence_type_id'] == $type['id'])
                                                                                echo "checked"; ?> type="radio"
                                                                                id="attendencetype<?php echo $value['student_session_id'] . "-" . $row_count; ?>"
                                                                                value="<?php echo $type['id'] ?>"
                                                                                name="attendencetype<?php echo $value['student_session_id']; ?>">
                                                                            <label
                                                                                for="attendencetype<?php echo $value['student_session_id'] . "-" . $row_count; ?>">
                                                            ...
                                                            ?>
                                                            <input type="hidden" value="<?php echo $checkres[$key]['id']?>" name="exist_id[]">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (i, obj) {
                            ...
                            div_data += "<option value=" + obj.id + " " + sel + ">" + obj.name + "(" + obj.code + ")</option>";
