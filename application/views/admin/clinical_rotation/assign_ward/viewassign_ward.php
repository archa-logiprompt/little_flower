<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-plus-square"></i> <?php echo $this->lang->line('assign_ward'); ?>
        </h1>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
					...
					<div class="download_label"><?php //echo $this->lang->line('student') . " " . $this->lang->line('report'); 
                                                ?></div>
                        <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                   ...
                                   <th><?php //echo $this->lang->line('group_name'); 
                                        ?></th>
                                    <th><?php //echo $this->lang->line('class'); 
                                        ?></th>
                                    <th><?php //echo $this->lang->line('section'); 
                                        ?></th>
                                    <th><?php //echo $this->lang->line('no_of_students'); 
                                        ?></th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    ?>
                                      ...
                                      <td><?php  //echo $ward->class; 
                                            ?></td>
                                         
                                       
                                        <td><?php //echo $ward->section;  
                                            ?></td>
                                        <td><?php //echo $ward->student_count;  
                                            ?></td> 
                                         <td><?php //echo $ward->datefrom." - ".$ward->dateto; 
                                                ?></td> 
                                               ...
                                               <td class="pull-right">
                                                    ...
                                                    <a  class="btn btn-info btn-xs schedule_modal" data-toggle="tooltip" title="" data-section_id="<?php //echo $ward->section_id 
                                                                                                                                                    ?>" data-class_id="<?php  //echo $ward->class_id
                                                                                                                                                                        ?>" data-ward_id="<?php //echo $ward->ward_id 
                                                                                                                                                                                            ?>" data-group_id="<?php  //echo $ward->group_id
                                                                                                                                                                                                                                                ?>" data-original-title="">
                ...
                <div class="box box-info" style="padding:5px;">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php //echo form_error('student'); 
                                                                                    ?> <?php echo $this->lang->line('assign_ward') ?></h3>
                    ...
                    <div class="box-body table-responsive">
                        <div class="download_label"><?php echo $this->Setting_model->getCurrentSchoolName(); ?></br>
                            <?php //echo $this->lang->line('student') . " " . $this->lang->line('report'); 
                            ?></div>
                        <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                ...
                                ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $ward->subject_name ?></td>
                                            ...
                                            <td class="pull-right">
                                                ...
                                                <a class="btn load btn-info btn-xs schedule_modal" data-toggle="tooltip" title="" data-section_id="<?php //echo $ward->section_id 
                                                                                                                                                    ?>" data-class_id="<?php  //echo $ward->class_id
                                                                                                                                                                        ?>" data-ward_id="<?php //echo $ward->ward_id 
                                                                                                                                                                                            ?>" data-datefrom="<?php echo $ward->datefrom . " - " . $ward->dateto; ?>" data-deptname="<?php echo $ward->deptname ?>" data-subject="<?php echo $ward->subject_name ?>" id="load" data-group_id="<?php echo $ward->group_id ?>" data-original-title="" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait..">
                                                    <?php echo $this->lang->line('view_details'); ?>
                                                </a>
    ...
    $(document).on('click', '.schedule_modal', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                data += "<p class='lead titlefix pt0' style='font-size: 16px; color: #a9181a;'> Department : " + deptname + "</p>";
                data += "<p class='lead titlefix pt0' style='font-size: 16px; color: #a9181a;'> Subject : " + subject + "</p>";
