        ...
        <div class="row">
            ...
            <form role="form" method="post" action="<?php echo site_url('admin/assign_ward/assign') ?>" id="assign_form">
                        ...
                        <div class="box-header ptbnull">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" style="margin-top: 12px;">
                                    ...
                                    <div class="form-group">
                                        <label style="color: #a9181a;">Subject</label>
               ...
               <input type="hidden" value="" name="end_time" id="out_time"  />-->
                              ...
                              <div class="form-group">  
                                    <label style="color: #a9181a;" ><?php //echo $this->lang->line('session'); 
                                                                    ?></label>
                                    ...
                                    ?>
                                        <option value="<?php //echo $list['id'] 
                                                        ?>"><?php //echo $list['session']
                                                            ?> </option>
                                        <?php  //}
                                        ?>
                                        
                                    </select>
                                    <span class="text-danger"><?php //echo form_error('wardname'); 
                                                                ?></span>
                                </div>  
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <!-- <th><?php //echo $this->lang->line('roll_no'); 
                                                    ?></th>-->
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    ...
                                                    <!--<input type="hidden" name="sectionid_<?php //echo $group['group_id']; 
                                                                                                ?>" value="<?php //echo $group['group_id']; 
                                                                                                            ?>">-->
                                                    <!--<input type="hidden" name="classid_<?php //echo $student['student_session_id'];
                                                                                            ?>" value="<?php //echo $student['class_id']; 
                                                                                                        ?>">
                              -->
                            ...
                            <!--<button type="submit" name="assign" value="assign_filter" class="btn btn-primary btn-sm checkbox-toggle pull-right"><i class="fa fa-search"></i> <?php //echo $this->lang->line('assign'); 
                                                                                                                                                                                    ?></button>-->
