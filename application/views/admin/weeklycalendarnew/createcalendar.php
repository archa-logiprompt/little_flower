        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" id="" class="addmarks-form" method="post" action="<?php echo site_url('admin/weeklycalendarnew/create') ?>">
                        <div class="box-body">
                            ...
                            <input type="submit" class="btn btn-primary pull-right" name="search" value="Search"></input>
                        </div>
                            ...
                            <div class="modal-dialog modal-dialog2 modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <form role="form" id="addcalendar_form" method="post" enctype="multipart/form-data" action="<?php echo base_url() . 'admin/weeklycalendarnew/savecalendar' ?>">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" autocomplete="off" readonly name="event_dates" class="form-control pull-right text-center" id="date-field-weekcalendar">
                                                    </div>
                                                </div>
                                                <div class="checkbox-container" style="text-align:center;">
                                                <!--    <input class="form-check-input" id="multiple-period-checkbox" type="checkbox" value="holiday">-->
                                                <!--    <label id="holiday" for="multiple-period-checkbox"><b>Holiday</b></label>-->
                                                <!--</div>-->
                                                <?php
                                                        ...
                                                        <div class="input-group flex-parent">
                                                            ...
                                                            ?>
                                                                ...
                                                                <div class="form-check flex-4">
                                                                    <input class="form-check-input" id='multiple-period-checkbox' type="checkbox" value="<?php echo $value['value'] ?>" label="<?php echo $value['time'] ?>" id="flexCheckDefault">
                                                            ...
                                                            <?php } ?>
                                                            <input type="text" name="multiple-activity" style="display:none" id="multiple_activity_id" class="form-control" placeholder="Enter Activity">
                                                        </div>
                                                */?>
                                                </div>
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1"><?php echo "$period_list->period_one_from - $period_list->period_one_to" ?></label>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="subject_id" name="subject_id[]" class="form-control subjectclass">
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1"><?php echo "$period_list->period_three_from - $period_list->period_three_to" ?></label>

                                                    </div>
                                                    <div class="form-group text-center">
                                                        <label for="typeofperiod">Class</label>
                                                        <input type="radio" name="periodtype[2]" class="periodtype-radio" value="class" checked>
                                                        <label for="typeofperiod">Other</label>
                                                        <input type="radio" name="periodtype[2]" class="periodtype-radio" value="other">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1"><?php echo "$period_list->period_four_from - $period_list->period_four_to" ?></label>

                                                    </div>
                                                    <div class="form-group text-center">
                                                        <label for="typeofperiod">Class</label>
                                                        <input type="radio" name="periodtype[3]" class="periodtype-radio" value="class" checked>
                                                        <label for="typeofperiod">Other</label>
                                                        <input type="radio" name="periodtype[3]" class="periodtype-radio" value="other">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1"><?php echo "$period_list->period_five_from - $period_list->period_five_to" ?></label>

                                                    </div>
                                                    <div class="form-group text-center">
                                                        <label for="typeofperiod">Class</label>
                                                        <input type="radio" name="periodtype[4]" class="periodtype-radio" value="class" checked>
                                                        <label for="typeofperiod">Other</label>
                                                        <input type="radio" name="periodtype[4]" class="periodtype-radio" value="other">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1"><?php echo "$period_list->period_six_from - $period_list->period_six_to" ?></label>

                                                    </div>
                                                    <div class="form-group text-center">
                                                        <label for="typeofperiod">Class</label>
                                                        <input type="radio" name="periodtype[5]" class="periodtype-radio" value="class" checked>
                                                        <label for="typeofperiod">Other</label>
                                                        <input type="radio" name="periodtype[5]" class="periodtype-radio" value="other">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1"><?php echo "$period_list->period_seven_from - $period_list->period_seven_to" ?></label>

                                                    </div>
                                                    <div class="form-group text-center">
                                                        <label for="typeofperiod">Class</label>
                                                        <input type="radio" name="periodtype[6]" class="periodtype-radio" value="class" checked>
                                                        <label for="typeofperiod">Other</label>
                                                        <input type="radio" name="periodtype[6]" class="periodtype-radio" value="other">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <!-- <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                        <label for="exampleInputEmail1"><?php echo "$period_list->period_eight_from - $period_list->period_eight_to" ?></label>

                                                    </div>
                                                    <div class="form-group text-center">
                                                        <label for="typeofperiod">Class</label>
                                                        <input type="radio" name="periodtype[7]" class="periodtype-radio" value="class" checked>
                                                        <label for="typeofperiod">Other</label>
                                                        <input type="radio" name="periodtype[7]" class="periodtype-radio" value="other">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <label for="exampleInputEmail1">Activity</label>
                                                        <select name="activity_id[]" id="activity_id" class="form-control activityclass">
                                                            <option value="">Select</option>
                                                            <option value="Sports">Sports</option>
                                                            <option value="Acts">Acts</option>
                                                            <option value="Holiday">Holiday</option>
                                                            <option value="other" other="other8">Other</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('Activity'); ?></span>

                                                    </div>
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                        <label for="other_activity">Other Activity:</label>
                                                        <input type="text" name="other_activity" id="other-activity" class="form-control" other="other8">
                                                    </div>
                            ...
                            <div class="modal-dialog modal-dialog2 modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <form role="form" id="updatecalendar_form" method="post" enctype="multipart/form-data" action="<?php echo base_url() . 'admin/weeklycalendarnew/updatecalendar' ?>">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" autocomplete="off" readonly name="event_dates" class="form-control pull-right text-center" id="date-field-weekcalendar-view">
                                                    </div>
                                                </div>
                                                <!--<div class="checkbox-container" style="text-align:center;">-->
                                                <!--    <input class="form-check-input" id="multiple-period-checkbox" type="checkbox" value="holiday">-->
                                                ...
                                                <div class="teacher-div">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <label for="exampleInputEmail1">Subject</label>
                                                        <select id="subject_id" name="subject_id[]" class="form-control subjectclass eight_to_nine_subject">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="teacher_id" name="teacher_id[]" class="form-control eight_to_nine_teacher">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                ...
                                                <div class="teacher-div">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <label for="exampleInputEmail1">Subject</label>
                                                        <select id="subject_id" name="subject_id[]" class="form-control subjectclass nine_to_ten_subject">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="teacher_id" name="teacher_id[]" class="form-control nine_to_ten_teacher">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1">Teacher</label>
                                                        <select id="activity_teacher_id" name="activity_teacher_id[]" class="form-control activityclass nine_to_ten_activity_teacher">
                                                            <option value="">Select</option>
                                                            <?php foreach ($teacherlist as $staff): ?>
                                                                <option value="<?php echo $staff['id'] ?>"><?php echo $staff['name']; ?></option>
                                                                <?php echo $staff['name']; ?>
                                                ...
                                                <div class="teacher-div">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <label for="exampleInputEmail1">Subject</label>
                                                        <select id="subject_id" name="subject_id[]" class="form-control subjectclass ten_to_eleven_subject">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="teacher_id" name="teacher_id[]" class="form-control ten_to_eleven_teacher">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="exampleInputEmail1">Topics</label>
                                                        <!-- <input id="eight_to_nine_topic"> -->
                                                        <select name="topic_id[]" class="form-control" id="ten_to_eleven_topic">
                                                            <option value="">Select Topic</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('topic_id'); ?></span>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1">Teacher</label>
                                                        <select id="activity_teacher_id" name="activity_teacher_id[]" class="form-control activityclass ten_to_eleven_activity_teacher">
                                                            <option value="">Select</option>
                                                            <?php foreach ($teacherlist as $staff): ?>
                                                                <option value="<?php echo $staff['id'] ?>"><?php echo $staff['name']; ?></option>
                                                                <?php echo $staff['name']; ?>
                                                ...
                                                <div class="teacher-div">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <label for="exampleInputEmail1">Subject</label>
                                                        <select id="subject_id" name="subject_id[]" class="form-control subjectclass eleven_to_twelve_subject">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="teacher_id" name="teacher_id[]" class="form-control eleven_to_twelve_teacher">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="exampleInputEmail1">Topics</label>
                                                        <!-- <input id="eight_to_nine_topic"> -->
                                                        <select name="topic_id[]" class="form-control" id="eleven_to_twelve_topic">
                                                            <option value="">Select Topic</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('topic_id'); ?></span>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1">Teacher</label>
                                                        <select id="activity_teacher_id" name="activity_teacher_id[]" class="form-control activityclass eleven_to_twelve_activity_teacher">
                                                            <option value="">Select</option>
                                                            <?php foreach ($teacherlist as $staff): ?>
                                                                <option value="<?php echo $staff['id'] ?>"><?php echo $staff['name']; ?></option>
                                                                <?php echo $staff['name']; ?>
                                                ...
                                                <div class="teacher-div">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <label for="exampleInputEmail1">Subject</label>
                                                        <select id="subject_id" name="subject_id[]" class="form-control subjectclass twelve_to_one_subject">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="teacher_id" name="teacher_id[]" class="form-control twelve_to_one_teacher">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="exampleInputEmail1">Topics</label>
                                                        <!-- <input id="eight_to_nine_topic"> -->
                                                        <select name="topic_id[]" class="form-control" id="twelve_to_one_topic">
                                                            <option value="">Select Topic</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('topic_id'); ?></span>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1">Teacher</label>
                                                        <select id="activity_teacher_id" name="activity_teacher_id[]" class="form-control activityclass twelve_to_one_activity_teacher">
                                                            <option value="">Select</option>
                                                            <?php foreach ($teacherlist as $staff): ?>
                                                                <option value="<?php echo $staff['id'] ?>"><?php echo $staff['name']; ?></option>
                                                                <?php echo $staff['name']; ?>
                                                ...
                                                <div class="teacher-div">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <label for="exampleInputEmail1">Subject</label>
                                                        <select id="subject_id" name="subject_id[]" class="form-control subjectclass two_to_three_subject">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="teacher_id" name="teacher_id[]" class="form-control two_to_three_teacher">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="exampleInputEmail1">Topics</label>
                                                        <!-- <input id="eight_to_nine_topic"> -->
                                                        <select name="topic_id[]" class="form-control" id="two_to_three_topic">
                                                            <option value="">Select Topic</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('topic_id'); ?></span>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1">Teacher</label>
                                                        <select id="activity_teacher_id" name="activity_teacher_id[]" class="form-control activityclass two_to_three_activity_teacher">
                                                            <option value="">Select</option>
                                                            <?php foreach ($teacherlist as $staff): ?>
                                                                <option value="<?php echo $staff['id'] ?>"><?php echo $staff['name']; ?></option>
                                                                <?php echo $staff['name']; ?>
                                                ...
                                                <div class="teacher-div">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <label for="exampleInputEmail1">Subject</label>
                                                        <select id="subject_id" name="subject_id[]" class="form-control subjectclass three_to_four_subject">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="teacher_id" name="teacher_id[]" class="form-control three_to_four_teacher">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="exampleInputEmail1">Topics</label>
                                                        <!-- <input id="eight_to_nine_topic"> -->
                                                        <select name="topic_id[]" class="form-control" id="three_to_four_topic">
                                                            <option value="">Select Topic</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('topic_id'); ?></span>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleInputEmail1">Teacher</label>
                                                        <select id="activity_teacher_id" name="activity_teacher_id[]" class="form-control activityclass three_to_four_activity_teacher">
                                                            <option value="">Select</option>
                                                            <?php foreach ($teacherlist as $staff): ?>
                                                                <option value="<?php echo $staff['id'] ?>"><?php echo $staff['name']; ?></option>
                                                                <?php echo $staff['name']; ?>
                                                ...
                                                <!-- <div class="teacher-div">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <label for="exampleInputEmail1">Subject</label>
                                                        <select id="subject_id" name="subject_id[]" class="form-control subjectclass four_to_five_subject">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select id="teacher_id" name="teacher_id[]" class="form-control four_to_five_teacher">
                                                            <option value="">Select</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('title'); ?></span>
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <select name="activity_id[]" id="activity_id" class="form-control activityclass">
                                                            ...
                                                            <option value="Acts">Acts</option>
                                                            <option value="Holiday">Holiday</option>
                                                            <option value="other" other="other16">Other</option>
                                                        </select>
                                                        <span class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                        <label for="other_activity">Other Activity:</label>
                                                        <input type="text" name="other_activity" id="other-activity" class="form-control" other="other16">
                                                    </div>
                                                </div> -->
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '#multiple-period-checkbox', function(e) {
            ...
            if (isChecked) {
                ...
                $('input[id=activity_id]').parent().hide()
                classRadio.prop('checked', true);

            }

            // Get the selected value of the activity_id select element
            var selectedActivity = $('#activity_id').val();

            // Check if the selected activity is "Holiday"
            if (selectedActivity === 'Holiday') {
                // Perform actions specific to when "Holiday" is selected
                // For example:
                console.log("Holiday selected!");
                // Add more code here as needed
            } else {
                // Perform actions for other selections if needed
                console.log("Other activity selected");
            }
        });
...
<script type="text/javascript">
        ...
        function getSamePeriods() {
            $('.fc-event-container').each(function(index, element) {
                ...
                contentarray.forEach(contentelement => {
                    var lastColonIndex = contentelement.lastIndexOf(':');
                    var time = contentelement.substring(0, lastColonIndex).trim();
                    var data = contentelement.substring(lastColonIndex + 1).trim();
                        ...
                        for (let key in msg) {
                            if (key.endsWith('_subject')) {
                                ...
                                if (msg[activity] != '' && msg[activity] != null) {
                                    ...
                                    $formGroups.slice(5).find('#activity_id').val(msg[activity])
                                    $formGroups.slice(5).show();
                                    $formGroups.slice(2, 5).hide();
                                }
    ...
    function showTextBox(selectElement) {
