<style type="text/css">
    ...
    .planning-table {
        display: block;
        /* Hides the table on screen */
    }

    @media print {
        .planning-table {
            display: none !important;
            /* Ensures the table is hidden when printing */
        }
    }
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    ?>
                                                                            <td style="text-align:center;position:relative">
                                                                                ...
                                                                                <?php if (
                                                                                    ...
                                                                                    <div style="text-align:center; background-color:<?php echo getsubjectcolor($value['eight_to_nine_subject']) ?> "
                                                                                        onclick="edit(<?php echo ($value['id']) ? $value['id'] : 'null'; ?>,'eight_to_nine_subject','eight_to_nine_teacher','<?php echo $daysvalue[$days] ?>','eight_to_nine_activity')">
                                                                                    <?php } else { ?>
                                                                                        <div style="text-align:center; background-color:<?php echo getsubjectcolor($value['eight_to_nine_subject']) ?> ">
                                                                                        <?php } ?>
                                                                    ...
                                                                    ?>
                                                                            ...
                                                                            <td style="text-align:center; position:relative">
                                                                                <?php if ( $userdata['id'] == 0) { ?>
                                                                                    <div style="text-align:center; background-color:<?php echo getsubjectcolor($value['nine_to_ten_subject']) ?>"
                                                                                        onclick="edit(<?php echo ($value['id']) ? $value['id'] : 'null'; ?>,'nine_to_ten_subject','nine_to_ten_teacher','<?php echo $daysvalue[$days] ?>','nine_to_ten_activity')">
                                                                                    <?php } else { ?>
                                                                                        <div style="text-align:center; background-color:<?php echo getsubjectcolor($value['nine_to_ten_subject']) ?>">
                                                                                        <?php } ?>
                                                                                        <?php echo ($subjectName = getsubjectname($value['nine_to_ten_subject'])) !== null ? $subjectName : $value['nine_to_ten_activity']; ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    ?>
                                                                            ...
                                                                            <td style="text-align:center;position:relative">
                                                                                <?php if ( $userdata['id'] == 0) { ?>
                                                                                    <div style="text-align:center; background-color:<?php echo getsubjectcolor($value['ten_to_eleven_subject']) ?>"
                                                                                        onclick="edit(<?php echo ($value['id']) ? $value['id'] : 'null'; ?>,'ten_to_eleven_subject','ten_to_eleven_teacher','<?php echo $daysvalue[$days] ?>','ten_to_eleven_activity')">
                                                                                    <?php } else { ?>
                                                                                        <div style="text-align:center; background-color:<?php echo getsubjectcolor($value['ten_to_eleven_subject']) ?>">
                                                                                        <?php } ?>
                                                                                        <?php echo ($subjectName = getsubjectname($value['ten_to_eleven_subject'])) !== null ? $subjectName : $value['ten_to_eleven_activity']; ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    ?>
                                                                            ...
                                                                            <td style="text-align:center; position:relative">
                                                                                <?php if ( $userdata['id'] == 0) { ?>
                                                                                    <div style="text-align:center; background-color:<?php echo getsubjectcolor($value['eleven_to_twelve_subject']) ?>"
                                                                                        onclick="edit(<?php echo ($value['id']) ? $value['id'] : 'null'; ?>,'eleven_to_twelve_subject','eleven_to_twelve_teacher','<?php echo $daysvalue[$days] ?>','eleven_to_twelve_activity')">
                                                                                    <?php } else { ?>
                                                                                        <div style="text-align:center; background-color:<?php echo getsubjectcolor($value['eleven_to_twelve_subject']) ?>">
                                                                                        <?php } ?>
                                                                                        <?php echo ($subjectName = getsubjectname($value['eleven_to_twelve_subject'])) !== null ? $subjectName : $value['eleven_to_twelve_activity']; ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    ?>
                                                                            ...
                                                                            <td style="text-align:center;position:relative">
                                                                                <?php if ( $userdata['id'] == 0) { ?>
                                                                                    <div style="text-align:center; background-color:<?php echo getsubjectcolor($value['twelve_to_one_subject']) ?>"
                                                                                        onclick="edit(<?php echo ($value['id']) ? $value['id'] : 'null'; ?>,'twelve_to_one_subject','twelve_to_one_teacher','<?php echo $daysvalue[$days] ?>','twelve_to_one_activity')">
                                                                                    <?php } else { ?>
                                                                                        <div style="text-align:center; background-color:<?php echo getsubjectcolor($value['twelve_to_one_subject']) ?>">
                                                                                        <?php } ?>
                                                                                        <?php echo ($subjectName = getsubjectname($value['twelve_to_one_subject'])) !== null ? $subjectName : $value['twelve_to_one_activity']; ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    ?>
                                                                            ...
                                                                            <td style="text-align:center;position:relative">
                                                                                <?php if ( $userdata['id'] == 0) { ?>
                                                                                    <div style="text-align:center; background-color:<?php echo getsubjectcolor($value['two_to_three_subject']) ?>"
                                                                                        onclick="edit(<?php echo ($value['id']) ? $value['id'] : 'null'; ?>,'two_to_three_subject','two_to_three_teacher','<?php echo $daysvalue[$days] ?>','two_to_three_activity')">
                                                                                    <?php } else { ?>
                                                                                        <div style="text-align:center; background-color:<?php echo getsubjectcolor($value['two_to_three_subject']) ?>">
                                                                                        <?php } ?> <br>
                                                                                        <?php echo ($subjectName = getsubjectname($value['two_to_three_subject'])) !== null ? $subjectName : $value['two_to_three_activity']; ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    ?>
                                                                            ...
                                                                            <td style="text-align:center;position:relative">
                                                                                <?php if ( $userdata['id'] == 0) { ?>
                                                                                    <div style="text-align:center;background-color:<?php echo getsubjectcolor($value['four_to_five_subject']) ?>"
                                                                                        onclick="edit(<?php echo ($value['id']) ? $value['id'] : 'null'; ?>, 'four_to_five_subject', 'four_to_five_teacher', '<?php echo $daysvalue[$days] ?>', 'four_to_five_activity')">
                                                                                    <?php } else { ?>
                                                                                        <div style="text-align:center;background-color:<?php echo getsubjectcolor($value['four_to_five_subject']) ?>">
                                                                                        <?php } ?>
                                                                                        <?php echo ($subjectName = getsubjectname($value['four_to_five_subject'])) !== null ? $subjectName : $value['four_to_five_activity']; ?>
                                                        ...
                                                        <thead>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td style="padding: 15px;text-align:center"><?php echo $value['name'] ?></td>
                                                                    <td style="padding: 15px;text-align:center"><?php echo ($value['total_hours']) . " hrs"; ?></td>
                                                                    <td style="padding: 15px;text-align:center"><?php echo number_format($value['completed'] / 60,2) . " hrs"; ?></td>
                                                                    <td style="padding: 15px;text-align:center"><?php echo number_format($value['planned'] / 60,2) . " hrs"; ?></td>
                                                                    <td style="padding: 15px;text-align:center"><?php echo number_format($value['total_hours'] - ($value['completed'] / 60),2) . "hrs"; ?></td>
